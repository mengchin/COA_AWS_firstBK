        ...
        const baseMapComponent = {
            ...
            methods: {
                ...
                addLayer:function(){
                    ...
                    this.taoyuanLayer = L.tileLayer.wms("http://35.76.62.63:8080/geoserver/taoyuan/wms", {
                    ...
                    //加入圖例
                    var legend_url ='http://35.76.62.63:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=' + self.classifyattributes;
